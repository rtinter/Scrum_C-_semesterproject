...
namespace commons {
    ...
    ImVec4 const Colors::ORANGE = {0.957, 0.455, 0.231, 1};
    ImVec4 const Colors::BLUE = {0.0, 0.671, 0.906, 1};
    ...
    ImVec4 const Colors::LAUREL_GREEN = {0.678, 0.722, 0.569, 1};
    ...
    ImVec4 const Colors::GOLD = {0.851, 0.788, 0.592, 1};
    ImVec4 const Colors::EARTH_YELLOW = {0.843, 0.694, 0.384, 1};
    ImVec4 const Colors::PURPLE = {0.36, 0.255, 0.529, 1};
    ImVec4 const Colors::SEAFOAM = {0.341, 0.635, 0.702, 1};
}
