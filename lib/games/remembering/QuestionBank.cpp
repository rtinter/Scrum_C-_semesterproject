        ...
        _questionSets = {
            {
                ...
                "Eine zweite Person wartete im Auto.\n",
                {
                    ...
                    {
                        "In welcher Straße liegt das Café?",
                        {"Bahnhofstraße", "Hauptstraße", "Nebenstraße", "Ringstraße"}, 1
                    },
                    ...
                    {
                        "Welches Kennzeichen hatte das Auto?", {"KI-CD 1234", "KI-AB 1234", "KI-EF 5678", "KI-GH 9012"},
                        1
                    },
            ...
            },
            {
                ...
                "rotes Fahrrad steigen und in Richtung Hauptstraße fahren.\n",
                {
                    ...
                    {
                        "Wie lange dauerte es, bis die Polizei eintraf?",
                        {"fünf Minuten", "zehn Minuten", "zwanzig Minuten", "dreißig Minuten"}, 1
                    },
                    {
                        "Wie heißt der Angreifer?", {"Thomas Müller", "Michael Wagner", "Hans Becker", "Peter Fischer"},
                        1
                    },
                    {
                        "Welches Verkehrsmittel benutzte der Täter zur Flucht?",
                        {"Auto", "Fahrrad", "Motorrad", "zu Fuß"}, 1
                    },
                    {
                        "In welche Richtung fuhr der Täter nach der Flucht aus dem Park?",
                        {"Nordstraße", "Hauptstraße", "Lindenstraße", "Parkstraße"}, 1
                    }
                }
            },
            {
                ...
                "Die Kassiererin berichtete, dass der Mann eine teure Flasche Whisky im Wert von 200 Euro gestohlen hatte.\n",
                {
                    ...
                    {
                        "In welchem Supermarkt befand sich die Person?",
                        {"Supermarkt", "Einkaufsparadies", "Shoppingcenter", "Lebensmittelmarkt"}, 1
                    },
                    {
                        "In welcher Straße liegt der Supermarkt?",
                        {"Hauptstraße", "Berliner Allee", "Marktstraße", "Bahnhofstraße"}, 1
                    },
                    ...
                    {
                        "Welches Kennzeichen hatte das Auto?", {"KI-AB 1234", "KI-CX 6789", "KI-XY 9876", "KI-CD 4321"},
                        1
                    },
                    {
                        "In welche Richtung fuhr der Täter nach dem Diebstahl?",
                        {"Stadtzentrum", "Bahnhof", "Autobahnauffahrt", "Park"}, 2
                    },
                    {
                        "Wie viel war die gestohlene Flasche Whisky wert?",
                        {"100 Euro", "150 Euro", "200 Euro", "250 Euro"}, 2
                    }
                }
            },
            {
                ...
                "Ein weiterer Zeuge, Frau Lisa Meier, sah den Täter in einen weißen Toyota Corolla steigen und in Richtung Bahnhof fahren.\n",
                {
                    ...
                    {
                        "In welcher Straße liegt das Kino?",
                        {"Hauptstraße", "Rosenstraße", "Gartenstraße", "Bahnhofstraße"}, 1
                    },
                    ...
                    {
                        "In welche Richtung fuhr der Täter nach dem Überfall?",
                        {"Stadtpark", "Marktplatz", "Bahnhof", "Autobahnauffahrt"}, 2
                    },
            ...
            },
            {
                ...
                "Die Ladenbesitzerin berichtete, dass der Mann mehrere Elektronikartikel im Wert von 800 Euro gestohlen hatte.\n",
                {
                    ...
                    {
                        "In welchem Einkaufszentrum befand sich die Person?",
                        {"Citti-Park", "Shopping Center", "Einkaufsparadies", "Mall of City"}, 0
                    },
                    {
                        "In welcher Straße liegt das Einkaufszentrum?",
                        {"Hauptstraße", "Gartenstraße", "Berliner Allee", "Bahnhofstraße"}, 1
                    },
                    ...
                    {
                        "Welches Kennzeichen hatte das Auto?", {"KI-AB 1234", "KI-CD 5678", "KI-EF 9012", "KI-KL 5678"},
                        3
                    },
                    {
                        "In welche Richtung fuhr der Täter nach dem Diebstahl?",
                        {"Stadtpark", "Marktplatz", "Innenstadt", "Autobahn"}, 2
                    },
                    {
                        "Wie viel waren die gestohlenen Elektronikartikel wert?",
                        {"500 Euro", "600 Euro", "700 Euro", "800 Euro"}, 3
                    }
                }
            },
            {
                ...
                "Opel Corsa mit dem Kennzeichen KI-XY 3456 steigen und wegfahren.\n",
                {
                    ...
                    {
                        "In welchem Restaurant saß die Person?",
                        {"Gourmet Palace", "Feinschmecker", "Delikatessen", "Essparadies"}, 0
                    },
                    {
                        "In welcher Straße liegt das Restaurant?",
                        {"Hauptstraße", "Königstraße", "Marktstraße", "Gartenstraße"}, 1
                    },
                    ...
                    {
                        "Welches Kennzeichen hatte das Auto?", {"KI-AB 1234", "KI-CD 5678", "KI-EF 9012", "KI-XY 3456"},
                        3
                    },
                    {
                        "In welche Richtung rannte der Täter nach dem Diebstahl?",
                        {"Stadtpark", "Marktplatz", "Flughafen", "Autobahnauffahrt"}, 2
                    },
                    {
                        "Wie viel Bargeld befand sich in der gestohlenen Handtasche?",
                        {"200 Euro", "250 Euro", "300 Euro", "350 Euro"}, 2
                    }
                }
            }
        };
