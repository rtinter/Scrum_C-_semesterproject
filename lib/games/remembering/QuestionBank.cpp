    ...
    questionSets = {
            ...
            },
            {
                    ...
                    "rotes Fahrrad steigen und in Richtung Hauptstraße fahren.\n",
                    {
                            ...
                            {"Um wieviel Uhr fand das Ereignis statt?", {"16:00", "17:45", "18:30", "19:00"}, 1},
            ...
            },
            {
                    ...
                    "Ich sah, wie er in einen blauen Volkswagen Passat mit dem Kennzeichen B-CX 6789 stieg und in Richtung Autobahnauffahrt fuhr. \n"
            ...
            },
            {
                    ...
                    "Plötzlich hörte ich Schreie aus dem Foyer. Ich eilte hinaus und \n"
            ...
            {
                    "Am 30. Juli 2024, um circa 10:00 Uhr, war ich im Einkaufszentrum City Mall in der Gartenstraße 45. \n"
                    ...
                    "mit dem Kennzeichen M-KL 5678 stieg und in Richtung Innenstadt fuhr. \n"
                    ...
                    "Die Ladenbesitzerin berichtete, dass der Mann mehrere Elektronikartikel im Wert von 800 Euro gestohlen hatte.\n",
                    {
                            ...
                            {"In welchem Einkaufszentrum befand sich die Person?", {"City Mall",      "Shopping Center", "Einkaufsparadies", "Mall of City"}, 0},
                            ...
                            {"Welches Kennzeichen hatte das Auto?",                  {"M-AB 1234", "M-CD 5678",  "M-EF 9012",  "M-KL 5678"},        3},
            ...
            },
            {
                    ...
                    "Plötzlich sah ich durch das Fenster einen Mann, etwa 1,90 Meter groß, mit einer roten Jacke und\n"
                    "einer schwarzen Mütze, der eine Handtasche von einer vorbeigehenden Frau stahl. \n"
                    "Der Mann rannte schnell in Richtung Bahnhof. Ich alarmierte sofort die Polizei, die wenige Minuten später eintraf. \n"
                    ...
                    "Opel Corsa mit dem Kennzeichen F-XY 3456 steigen und wegfahren.\n",
                    {
                            ...
                            {"Welches Kennzeichen hatte das Auto?",                  {"F-AB 1234", "F-CD 5678",  "F-EF 9012",  "F-XY 3456"},        3},
                            {"In welche Richtung rannte der Täter nach dem Diebstahl?", {"Stadtpark", "Marktplatz", "Bahnhof",    "Autobahnauffahrt"}, 2},
...
const QuestionBank::QuestionSet &QuestionBank::getRandomQuestionSet() const {
    ...
    std::uniform_int_distribution<> dis(0, questionSets.size() - 1);
    return questionSets[dis(gen)];
}
