...
namespace matrix {
     ...
     */
    void Matrix::init(int const nMarkedCells) {
    ...
    bool Matrix::isMirroredVersionOf(Matrix const &other) const {
        ...
        return std::any_of(mirroredVersions.begin(), mirroredVersions.end(), [this](Matrix const &mirrored) {
    ...
    bool Matrix::isRotatedVersionOf(Matrix const &other) const {
        ...
        return std::any_of(rotatedVersions.begin(), rotatedVersions.end(), [this](Matrix const &rotated) {
